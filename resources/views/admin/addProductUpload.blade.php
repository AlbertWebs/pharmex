                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-10">
                                            <form method="POST" action="{{route('add-Product-Upload-post')}}" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="mb-3 row">
                                                    <label for="example-email-input" class="col-sm-2 col-form-label text-end">Upload Medicines</label>
                                                    <div class="col-sm-5">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <span class="fa fa-file-excel fa-2x"></span> <a download href="{{url('/')}}/uploads/templates/upload.xlsx">Download Templete</a>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                <hr>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <button class="btn btn-primary" type="submit">Upload Medicines File</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
