                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea id="basic-conf">Hello, World! Your Brand description goes here</textarea>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <ul class="list-group list-group-flush">
                                                                    <li class="list-group-item"><i class="la la-angle-double-right text-info me-2"></i>Brand 1</li>
                                                                    <li class="list-group-item"><i class="la la-angle-double-right text-info me-2"></i>Brand 2</li>
                                                                    <li class="list-group-item"><i class="la la-angle-double-right text-info me-2"></i>Brand 3</li>
                                                                    <li class="list-group-item"><i class="la la-angle-double-right text-info me-2"></i>Brand 4</li>
                                                                </ul>
                                                            </div><!--end col-->
                                                        </div><!--end row-->
                                                    </div><!--end card-body-->
