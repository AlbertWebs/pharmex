                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Home Page Video</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-8" >
                                            <form method="POST" action="{{route('update-embeded-video')}}" enctype="multipart/form-data">
                                                @csrf
                                                @foreach ($Settings as $sett)
                                                <div class="mb-3 row">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label text-end">Video Code</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" name="embede" type="text" value="{{$sett->embede}}" id="example-text-input">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-4" >
                                            <iframe id="player" type="text/html" width="640" height="390"
                                                src="http://www.youtube.com/embed/{{$sett->embede}}"
                                                frameborder="0">
                                            </iframe>
                                        </div>
