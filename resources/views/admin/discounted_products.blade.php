                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Discounted Medicines</h4>
                                        ...
                                        <div class="col align-self-center">
                                            <div class="media">
                                                ...
                                                <div class="media-body align-self-center ms-3">
                                                    ...
                                                    <h6 class="m-0 font-24 fw-bold">kes {{number_format(\App\Models\Product::where('distribution','Discounted')->sum('price'), 2)}}</h6>
                                                    <p class="text-muted mb-0">Total Value of Discounted Products</p>
                                                </div><!--end media body-->
                                            </div><!--end media-->
                                        </div><!--end col-->
