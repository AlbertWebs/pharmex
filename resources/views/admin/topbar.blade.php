            ...
            <nav class="navbar-custom" id="navbar-custom">
                <ul class="list-unstyled topbar-nav float-end mb-0">
                    <li class="dropdown">
                        ...
                        <img src="{{asset('admin/assets/images/flags/ke.png')}}" alt="" class="thumb-xxs rounded">
                    </a>
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle nav-user" data-bs-toggle="dropdown" href="#" role="button"
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{asset('admin/assets/images/users/user-1.jpg')}}" alt="profile-user" class="rounded-circle me-2 thumb-sm" />
                                <div>
                                    <small class="d-none d-md-block font-11">Admin</small>
                                    <span class="d-none d-md-block fw-semibold font-12">Bevin Likuyani <i
