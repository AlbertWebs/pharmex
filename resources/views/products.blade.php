...
<html>
<head>
    <title>Laravel 11 Import Export Excel Tool - pharmex.com</title>
...
<div class="container">
    <div class="card mt-5">
        <h3 class="card-header p-3"><i class="fa fa-star"></i> Laravel 11.2 Import Export Excel Tool - pharmex.com</h3>
        <div class="card-body">
