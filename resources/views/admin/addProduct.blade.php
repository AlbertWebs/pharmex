                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea id="basic-conf">Hello, World! Your Product description goes here</textarea>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <ul class="list-group list-group-flush">
                                                                    <li class="list-group-item"><i class="la la-angle-double-right text-info me-2"></i>Product 1</li>
                                                                    <li class="list-group-item"><i class="la la-angle-double-right text-info me-2"></i>Product 2</li>
                                                                    <li class="list-group-item"><i class="la la-angle-double-right text-info me-2"></i>Product 3</li>
                                                                    <li class="list-group-item"><i class="la la-angle-double-right text-info me-2"></i>Product 4</li>
                                                                </ul>
                                                            </div><!--end col-->
                                                        </div><!--end row-->
                                                    </div><!--end card-body-->
