                                        ...
                                        <div class="col-lg-6">
                                            <form method="POST" action="{{route('add-admin-post')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" name="company" id="example-text-input">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" name="position" id="example-text-input">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" name="license" id="example-text-input">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
